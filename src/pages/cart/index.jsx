...
import {CartEmpty, renderItems} from '@/pages/cart/cart.func';
import {
  addPizzaToCart,
  decreaseItemInCart,
...
const Cart = () => {
  ...
  const {cartItems, totalCount, totalPrice} = useSelector(({cart}) => ({
    cartItems: cart.cartItems,
    totalCount: cart.totalItems,
    totalPrice: cart.totalPrice
  }))

  const decreaseItem = (infoObj) => {
    dispatch(decreaseItemInCart(infoObj))
  }

  const increaseItem = (infoObj) => {
    dispatch(increaseItemInCart(infoObj))
  }
  ...
  const deleteAType = (infoObj) => {
    dispatch(removeTypeInCart(infoObj))
  }
    ...
    <div className="container container--cart">
      <div className="cart">
        ...
        <div className="content__items">
          {renderItems(cartItems, {decreaseItem, increaseItem, deleteAType})}
        </div>
